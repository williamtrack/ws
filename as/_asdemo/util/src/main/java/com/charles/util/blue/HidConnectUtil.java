...
public class HidConnectUtil {
    ...
    @SuppressLint("NewApi")
    public static int getHeadSetDeviceHiddenConstant() {
        Class<BluetoothProfile> clazz = BluetoothProfile.class;
        for (Field f : clazz.getFields()) {
            int mod = f.getModifiers();
            if (Modifier.isStatic(mod) && Modifier.isPublic(mod)
    ...
    private BluetoothProfile.ServiceListener connect = new BluetoothProfile.ServiceListener() {
        ...
        public void onServiceConnected(int profile, BluetoothProfile proxy) {
            ...
            try {
                if (profile == getInputDeviceHiddenConstant()||profile == getHeadSetDeviceHiddenConstant()) {
                    if (device != null) {
    ...
    public void connect(final BluetoothDevice bluetoothDevice) {
        ...
        try {
            ...
            BluetoothAdapter.getDefaultAdapter().getProfileProxy(context,
                    connect, getHeadSetDeviceHiddenConstant());
        } catch (Exception e) {
    ...
    public void disConnect(BluetoothDevice bluetoothDevice) {
        ...
        try {
            ...
            BluetoothAdapter.getDefaultAdapter().getProfileProxy(context,
                    disConnect, getHeadSetDeviceHiddenConstant());
        } catch (Exception e) {
